...
if __name__ == '__main__':
    ...
    model = LlamaForCausalLM.from_pretrained(model_name).cuda()  # Using LLaMA-specific model class
    ...
    for pos_tag in ['REASONING']: 
        ...
        for i in trange(len(dataset)):
            ...
            # if it generates a space, it should generate another token
        ...
        output_df.to_csv(f'Llama-2-7b_{pos_tag}.csv', index = False)
